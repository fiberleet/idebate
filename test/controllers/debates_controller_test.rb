...
class DebatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create debate" do
    assert_difference('Debate.count') do
      post debates_url, params: { debate: { argument_id: @debate.argument_id, topic: @debate.topic, user_id: @debate.user_id } }
    end
  ...
  test "should update debate" do
    patch debate_url(@debate), params: { debate: { argument_id: @debate.argument_id, topic: @debate.topic, user_id: @debate.user_id } }

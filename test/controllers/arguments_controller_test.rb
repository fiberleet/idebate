...
class ArgumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create argument" do
    assert_difference('Argument.count') do
      post arguments_url, params: { argument: { body: @argument.body, title: @argument.title, user_id: @argument.user_id } }
    end
  ...
  test "should update argument" do
    patch argument_url(@argument), params: { argument: { body: @argument.body, title: @argument.title, user_id: @argument.user_id } }
